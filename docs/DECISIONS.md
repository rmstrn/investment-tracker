...
- `docs/product/03_NAMING.md` → Round 6 placeholder added. Round 5 preserved. PO lean noted but not locked. See `docs(naming)` commit.
...
## 2026-04-23 — Product name SUPERSEDED

An earlier product-name lock was superseded by the **2026-04-25 Provedo lock** (see `docs/product/03_NAMING.md`). Original ADR removed per PO directive 2026-04-27. Domains owned: provedo.ai + provedo.app.
...
- **Blinking icons on contextual elements** (position cards, dashboard widgets, relevant chat threads) when Provedo notices a pattern tied to that element. Icon click → teaser message.
