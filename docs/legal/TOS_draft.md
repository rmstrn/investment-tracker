...
### 6.1 Tiers
The Service offers a **Free** tier and paid tiers (**Plus** and **Pro** as described at `memoro.co/pricing` at any given time). Tier feature sets may change with reasonable notice; material reductions to paid-tier functionality will be communicated at least 30 days in advance and, where applicable, entitle you to a prorated refund.
...
### 7.1 Our IP
The Service, including software, UI, branding (Memoro), and content we create, is owned by us or our licensors and protected by copyright, trademark, and other laws. We grant you a limited, non-exclusive, non-transferable, revocable license to access and use the Service for your personal, non-commercial purposes subject to these Terms.
...
We reserve the right to update Memoro's UK offering to reflect changes in FCA guidance or regulatory perimeter.

> `[ATTORNEY REVIEW]` — UK Consumer Duty application to non-regulated activities is nuanced. FCA has signaled Consumer Duty obligations can attach to firms within the regulatory perimeter; Memoro's perimeter position must be confirmed with FCA-experienced counsel before UK launch. If Memoro is determined to be outside the perimeter entirely, Consumer Duty may not strictly apply, but this voluntary alignment is defensible positioning.
...
**Memoro не является зарегистрированным инвестиционным советником. Memoro не является брокером, дилером или финансовым институтом. Сервис предоставляет информацию о портфеле, агрегацию и образовательные комментарии. Сервис не предоставляет инвестиционных советов, рекомендаций или побуждений купить, продать, удержать или совершить сделку с каким-либо финансовым инструментом. Все инвестиционные решения вы принимаете самостоятельно. Прошлая доходность не гарантирует будущую.**

**Используя Memoro, вы подтверждаете понимание этого.**

---

## 1. Стороны и принятие

Настоящие Условия использования («Условия») являются обязывающим соглашением между вами («вы», «Пользователь») и **`[ЮРЛИЦО — TBD]`** («Memoro», «мы»), оператором сервиса Memoro на `memoro.co` и связанных ресурсах (совместно — «Сервис»).
...
## 2. Что такое Memoro — и чем Memoro не является
...
AI-контент в Сервисе — информационный и образовательный. Может содержать ошибки, упускать контекст или неправильно интерпретировать ваши данные. Всё важное проверяйте своим исследованием, у брокера или у лицензированного специалиста. Не полагайтесь на Memoro как единственную основу для инвестиционных, налоговых или правовых решений.
...
### 6.1 Тарифы
**Free**, **Plus** и **Pro** (детали на `memoro.co/pricing`). Набор функций может меняться с разумным уведомлением; существенное сокращение функций платного тарифа — минимум за 30 дней, с пропорциональным возвратом где применимо.
